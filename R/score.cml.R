...
score.cml <- function(para, map, data, ref, inv.V, bet0, sample.info, outcome){
  
  #return(grad(obj.cml, para, map = map, data = data, ref = ref, inv.V = inv.V, bet0 = bet0, sample.info = sample.info, outcome = outcome))
